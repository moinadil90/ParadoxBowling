...
/**
 * Created by Moin Adil on 2018-08-03. Provides methods for determining the level of user interaction with the
...
public final class AppRater {
    ...
    private static final String APP_PACKAGE_NAME = "ca.moinadil.paradoxbowling";
