...
/**
 * Created by Moin Adil on 2018-08-03. Provides methods and constants for enabling the transferring of data to a new
 * device.
 */
public final class TransferUtils {
    ...
    public static void loadTransferServerUrl(Resources resources) {
       //If required, we add transfer of data, to other mobile from here
    }
