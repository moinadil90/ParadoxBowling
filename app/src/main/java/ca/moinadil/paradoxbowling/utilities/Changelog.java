...
/**
 * Created by Moin Adil on 2018-08-03. Provides utilities to handle displaying the changelog of the application to
 * the user each time a new update will become available.
 */
