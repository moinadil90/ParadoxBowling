...
/**
 * Created by Moin Adil on 2018-08-03. Displays some content which describes the functionality of the application to
 * the user.
 */
public class TutorialFragment
    ...
    /**
     * A cached array of the {@link ca.moinadil.paradoxbowling.fragment.TutorialFragment.TutorialPage} items.
     */
