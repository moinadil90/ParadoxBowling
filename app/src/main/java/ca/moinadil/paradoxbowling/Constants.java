...
/**
 * Created by Moin Adil on 2018-08-03. <p/> Provides constant values which are accessible across the entire
 * application
 */
public final class Constants {
    ...
    public static final String PREFS = "ca.moinadil.paradoxbowling";
