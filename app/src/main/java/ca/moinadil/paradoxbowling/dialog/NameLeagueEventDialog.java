package ca.moinadil.paradoxbowling.dialog;
...
/**
 * Created by Moin Adil on 18-08-03. Provides dialog and callback interface {@link
 * ca.moinadil.paradoxbowling.dialog.NameLeagueEventDialog.NameLeagueEventDialogListener} for the user to enter the
